...
def create_sphere_at_position(position, radius=0.05):
...
while True:
    ...
    #CREAZIONE SFERE
    #if sphere_counter % 10 == 0:
     #   end_effector_position = p.getLinkState(robotId, end_effector_index)[0]
      #  create_sphere_at_position(end_effector_position)
    #sphere_counter += 1
